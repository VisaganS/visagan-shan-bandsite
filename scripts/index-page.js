arrComments = [
    {name: 'Connor Walton',
     ...
     comment: 'This is art. This is inexplicable magic expressed in the purest way, everything that makes up this majestic work ' + 
...
function displayComments(){
    ...
    arrComments.forEach(element =>{
        ...
        itemImageEl.classList.add('card__image');
